...
import 'package:avant/visit/self_stock_series_title_wise.dart';
...
class SelfStockRequestSearch extends StatefulWidget {
  ...
  @override
  SelfStockRequestSearchPageState createState() =>
      SelfStockRequestSearchPageState();
}

class SelfStockRequestSearchPageState extends State<SelfStockRequestSearch>
  ...
  void _submitForm() {
    ...
    if (selectedIndex == 0 && selectedSeries == null) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => SelfStockSeriesTitleWise(
            type: widget.type,
            title: widget.title,
